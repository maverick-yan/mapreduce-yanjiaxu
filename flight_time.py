from mapreduce_proto import MapReduce
import sys
...
class WordCount(MapReduce):
    ...
    def mapper(self, key, value):
        """Map function for the flight time count
        Note: each line only count the passenger id 
        """
        results = []
        count = 1
    ...
    def reducer(self, key, values):
        ...
        """
        flight_count = sum(value for value in values)
